<script>
    ...
    export let shippingMethods = ["Standard", "Express", "Priority", "Local Delivery"];
...
<div class="order-form-container">
    <div class="form-header">
        <h3>Create New Shipping Order</h3>
    ...
    <form on:submit|preventDefault={submitForm}>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <label class="checkbox-label">
                    ...
                    <input type="checkbox" bind:checked={formData.freeShipping} />
                </label>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            {/each}
            <button class="btn btn-add-item" type="button" on:click={addShippingOrderItem}>＋ Add Item</button>
        </div>

        <div class="form-actions">
            <button class="btn btn-primary" type="submit">Create Shipping Order</button>
        </div>
    </form>
</div>
