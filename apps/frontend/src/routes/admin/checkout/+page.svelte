            ...
            const res = await fetch(`${PUBLIC_BACKEND_URL}/api/customer-orders`, {
                ...
                body: JSON.stringify({
                    ...
                    items: $cart.map((item) => ({
                        ...
                        priceAtTimeOfSale: item.variant.salePrice,
                    })),
                    total: $total,
...
<div class="checkout-container">
    ...
    <div class="checkout-flex">
        <div class="product-search">
            <input type="text" placeholder="Search SKU, name, color, size..." bind:value={$search} />
                            ...
                            <tbody>
                                {#each product.variants as variant}
                                    <tr>
                                        ...
                                        <td>{variant.stock}</td>
                                        <td><button type="button" on:click={() => addToCart(variant)}>Add</button></td>
                                    </tr>
                                {/each}
                            </tbody>
                        </table>
